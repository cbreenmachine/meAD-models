...
write_csv(df[ix.1, ], "../data/07-counts-by-chrom-imputed-subset1/master-42-subsampled-1.csv")
write_csv(df[ix.2, ], "../data/07-counts-by-chrom-imputed-subset2/master-42-subsampled-2.csv")